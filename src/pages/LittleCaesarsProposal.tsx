...
const LittleCaesarsProposal = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Slide 1: Mission */}
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#E66200] to-[#FF8533] text-white relative overflow-hidden py-12">
        <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-8 sm:mb-12 font-light">
              Three posts, six stories, zero blandness.<br className="hidden sm:block"/>
              Let's make Little Caesars unforgettable
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 mt-8 sm:mt-16 text-left">
              <div className="bg-white/10 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-white/20">
                <h3 className="text-lg sm:text-2xl font-bold mb-2 sm:mb-3">Feed Creative Trio</h3>
                <p className="text-sm sm:text-base text-white/90">3 unique posts - Reel, Carousel & Static</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-white/20">
                <h3 className="text-lg sm:text-2xl font-bold mb-2 sm:mb-3">Story Sequence</h3>
                <p className="text-sm sm:text-base text-white/90">6 stories across 2 engaging arcs</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-white/20">
                <h3 className="text-lg sm:text-2xl font-bold mb-2 sm:mb-3">Complete Package</h3>
                <p className="text-sm sm:text-base text-white/90">Captions, hashtags & alt text included</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="min-h-screen flex items-center py-12 sm:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-8 sm:mb-12 text-[#E66200]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16">
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="bg-orange-50 border-l-4 border-[#E66200] p-4 sm:p-6 rounded-r-xl">
                  <p className="text-base sm:text-xl text-gray-800">
              ...
              <div className="bg-gradient-to-br from-[#E66200] to-[#FF8533] text-white p-6 sm:p-10 rounded-3xl shadow-2xl">
                <h3 className="text-xl sm:text-3xl font-bold mb-6 sm:mb-8">The Secret Sauce of Solutions:</h3>
      ...
      <section className="min-h-screen flex items-center py-12 sm:py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-lg sm:text-2xl text-gray-700 mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 mb-8 sm:mb-12">
              <div className="bg-white p-4 sm:p-8 rounded-2xl shadow-lg border-2 border-[#E66200]/20 hover:border-[#E66200] transition-all">
                <div className="text-[#E66200] text-2xl sm:text-5xl font-bold mb-2 sm:mb-4">Who</div>
                <p className="text-sm sm:text-xl text-gray-700">are we?</p>
              </div>
              <div className="bg-white p-4 sm:p-8 rounded-2xl shadow-lg border-2 border-[#E66200]/20 hover:border-[#E66200] transition-all">
                <div className="text-[#E66200] text-2xl sm:text-5xl font-bold mb-2 sm:mb-4">What</div>
                <p className="text-sm sm:text-xl text-gray-700">do we do?</p>
              </div>
              <div className="bg-white p-4 sm:p-8 rounded-2xl shadow-lg border-2 border-[#E66200]/20 hover:border-[#E66200] transition-all">
                <div className="text-[#E66200] text-2xl sm:text-5xl font-bold mb-2 sm:mb-4">How</div>
                <p className="text-sm sm:text-xl text-gray-700">do we do it?</p>
              </div>
              <div className="bg-white p-4 sm:p-8 rounded-2xl shadow-lg border-2 border-[#E66200]/20 hover:border-[#E66200] transition-all">
                <div className="text-[#E66200] text-2xl sm:text-5xl font-bold mb-2 sm:mb-4">Why</div>
                <p className="text-sm sm:text-xl text-gray-700">should you care?</p>
              </div>
              <div className="bg-white p-4 sm:p-8 rounded-2xl shadow-lg border-2 border-[#E66200]/20 hover:border-[#E66200] transition-all">
                <div className="text-[#E66200] text-2xl sm:text-5xl font-bold mb-2 sm:mb-4">When</div>
                <p className="text-sm sm:text-xl text-gray-700">are we coming to India?</p>
              </div>
              <div className="bg-white p-4 sm:p-8 rounded-2xl shadow-lg border-2 border-[#E66200]/20 hover:border-[#E66200] transition-all">
                <div className="text-[#E66200] text-2xl sm:text-5xl font-bold mb-2 sm:mb-4">Where</div>
                <p className="text-sm sm:text-xl text-gray-700">are we launching our first store?</p>
              </div>
            </div>

            <div className="bg-gradient-to-r from-[#E66200] to-[#FF8533] text-white p-6 sm:p-8 rounded-2xl text-center">
      ...
      <section className="min-h-screen flex items-center py-8 sm:py-4 bg-white">
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-[#E66200]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div className="relative order-1 md:order-1">
                <div className="rounded-2xl shadow-2xl overflow-hidden max-w-[280px] sm:max-w-xs mx-auto aspect-[9/16]">
                  <iframe 
              ...
              <div className="space-y-4 order-2 md:order-2">
                ...
                <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-gray-200">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">Post Descriptor</h3>
      ...
      {/* Slide 5: Creative 2 */}
      <section className="min-h-screen flex items-center py-8 sm:py-4 bg-gradient-to-br from-gray-900 to-black text-white">
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div className="space-y-4 order-2 md:order-1">
                ...
                <div className="bg-white/10 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-white/20">
                  <h3 className="text-lg sm:text-xl font-bold mb-3">Post Descriptor</h3>
      ...
      <section className="min-h-screen flex items-center py-8 sm:py-4 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 sm:mb-8 text-[#E66200]">
              What Do We Do?
            </h2>
            <p className="text-xl sm:text-3xl text-gray-800 mb-8 sm:mb-12 font-semibold">Give you Hot-N-Ready pies</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              {/* Story Video */}
              <div className="relative">
                <div className="rounded-3xl shadow-2xl overflow-hidden max-w-[280px] sm:max-w-sm mx-auto aspect-[9/16]">
                  <iframe 
              ...
              {/* Content */}
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg border-2 border-[#E66200]">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Post Descriptor</h3>
      ...
      <section className="min-h-screen flex items-center py-8 sm:py-4 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="space-y-4 sm:space-y-6 order-2 md:order-1">
                ...
                <div className="bg-orange-50 p-4 sm:p-6 rounded-2xl border-l-4 border-[#E66200]">
                  <h3 className="text-lg sm:text-xl font-bold text-[#E66200] mb-2">Purpose</h3>
                  <p className="text-gray-800 text-sm sm:text-base">Reinforce the "Hot-N-Ready" experience with quirky visuals.</p>
                </div>
              ...
              {/* Story Video */}
              <div className="relative order-1 md:order-2">
                <div className="rounded-3xl shadow-2xl overflow-hidden max-w-[280px] sm:max-w-sm mx-auto aspect-[4/3]">
                  <iframe 
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-orange-50 p-4 sm:p-6 rounded-2xl border-l-4 border-[#E66200]">
                  <h3 className="text-lg sm:text-xl font-bold text-[#E66200] mb-2">Purpose</h3>
                  <p className="text-gray-800 text-sm sm:text-base">Highlight the speed and freshness of Little Caesars' pizzas, making the Hot-N-Ready promise tangible.</p>
                </div>
      ...
      <section className="min-h-screen flex items-center py-8 sm:py-4 bg-gradient-to-br from-[#E66200] to-[#FF8533] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 sm:mb-8">
              How Do We Do It?
            </h2>
            <p className="text-lg sm:text-2xl md:text-3xl mb-8 sm:mb-12 font-light">Fresh dough, vine-ripened tomatoes, and cheese that makes you swoon</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              {/* Story Video with Interactive Element */}
              <div className="relative">
                <div className="rounded-3xl shadow-2xl overflow-hidden max-w-[280px] sm:max-w-sm mx-auto border-4 border-white/30 aspect-[9/16]">
                  <iframe 
              ...
              {/* Content */}
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white/10 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-white/30">
                  <h3 className="text-lg sm:text-xl font-bold mb-2">Purpose</h3>
                  <p className="text-white/90 text-sm sm:text-base">Educate viewers about Little Caesars' fresh ingredients in a fun, engaging way.</p>
                </div>

                <div className="bg-white text-gray-900 p-6 sm:p-8 rounded-2xl shadow-2xl">
                  <h3 className="text-xl sm:text-2xl font-bold mb-4">Post Descriptor</h3>
      ...
      <section className="min-h-screen flex items-center py-8 sm:py-4 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl md:text-3xl text-gray-800 mb-8 sm:mb-12 font-semibold">Coz all roads lead to Little Caesars</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-start">
              ...
              <div className="relative">
                ...
                <div className="mt-4 bg-[#E66200] text-white px-4 py-2 rounded-lg inline-block text-sm">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-orange-50 p-4 sm:p-6 rounded-2xl border-l-4 border-[#E66200]">
                  <h3 className="text-lg sm:text-xl font-bold text-[#E66200] mb-2">Purpose</h3>
                  <p className="text-gray-800 text-sm sm:text-base">Highlight the dine-in experience, showcasing pizza moments and social enjoyment.</p>
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              {/* Content */}
              <div className="space-y-4 sm:space-y-6 order-2 md:order-1">
                <div className="bg-[#E66200]/20 p-4 sm:p-6 rounded-2xl border-l-4 border-[#E66200]">
                  <h3 className="text-lg sm:text-xl font-bold text-[#E66200] mb-2">Purpose</h3>
                  <p className="text-white/90 text-sm sm:text-base">Engage audiences with the store location story and make them curious to visit.</p>
                </div>
              ...
              <div className="relative order-1 md:order-2">
                <div className="rounded-3xl shadow-2xl overflow-hidden max-w-[280px] sm:max-w-sm mx-auto border-4 border-[#E66200]/30 aspect-[9/16]">
                  <iframe 
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
              {/* Story Video with Interactive */}
              <div className="relative">
                <div className="rounded-3xl shadow-2xl overflow-hidden max-w-[280px] sm:max-w-sm mx-auto border-4 border-yellow-400/50 aspect-[9/16]">
                  <iframe 
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-orange-50 p-4 sm:p-6 rounded-2xl border-l-4 border-[#E66200]">
                  <h3 className="text-lg sm:text-xl font-bold text-[#E66200] mb-2">Purpose</h3>
                  <p className="text-gray-800 text-sm sm:text-base">Build excitement and anticipation around the launch date.</p>
                </div>
      ...
      <section className="min-h-screen flex items-center py-8 sm:py-4 bg-gradient-to-br from-[#E66200] to-[#FF8533] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-8 sm:mb-12 text-center">
              Countdown
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-start">
              {/* Countdown Carousel */}
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-8 border border-white/30">
                  ...
                  <p className="text-center text-white/70 mt-4 text-sm">Creative 10 - Countdown Static</p>
                </div>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white/10 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-white/30">
                  <h3 className="text-lg sm:text-xl font-bold mb-2">Purpose</h3>
                  <p className="text-white/90 text-sm sm:text-base">Amplify launch excitement and reinforce countdown messaging.</p>
                </div>
      ...
      <section className="min-h-screen flex items-center py-12 sm:py-20 bg-gradient-to-br from-gray-900 to-black text-white">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-8 sm:mb-12 text-center text-[#E66200]">
